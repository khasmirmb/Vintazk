<div class="w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
  <div class="flex justify-between">
    <div>
      <h5 class="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">Teams: {{ number_format($totalteams) }}</h5>
      <p class="text-base font-normal text-gray-500 dark:text-gray-400">Teams Monthly Average Performance</p>
    </div>
  </div>
...
<script type="module">
    ...
    const team_months = @json($teams_months); // ["Jan 2025", "Feb 2025", ..., "Aug 2025"]
    const team_performance = @json($teams_performance); // [100, 99, 98, ..., 94] (in thousands)
